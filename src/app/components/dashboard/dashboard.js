System.register(['@angular/core', '../alerts/alerts', '../rd-loading/rd-loading', '../rd-widget/rd-widget', '../rd-widget-header/rd-widget-header', '../rd-widget-body/rd-widget-body', '../rd-widget-footer/rd-widget-footer', '../server-list-view/server-list-view', '../../services/server_list', '../user-list-view/user-list-view', '../../services/user_list'], function (exports_1, context_1) {
  'use strict'
  ...
  var core_1, alerts_1, rd_loading_1, rd_widget_1, rd_widget_header_1, rd_widget_body_1, rd_widget_footer_1,
    server_list_view_1, server_list_1, user_list_view_1, user_list_1, Dashboard
  return {
    setters: [
      function (core_1_1) {
        core_1 = core_1_1
